...
const SubcategoryManagerScreen = ({ navigation, route }) => {
  const [categories, setCategory] = useState([]);
  const { subcategories, categoryId } = route.params || {};
  const [subcategoryName, setSubcategoryName] = useState("");
  const [updateName, setUpdateName] = useState("");
  const [subcategoryId, setSubcategoryId] = useState("")
  const [subcategoryArr, setSubcategoryArr] = useState(subcategories)
  ...
  const getSubcategory = () => {
    axios
      .get(`${API_BASE_URL}/admin/Category/${categoryId}`)
      .then(function (response) {
        setSubcategoryArr(response.data.data.subCategory);
      })
  ...
  const newSubCategory = () => {
    axios
      .post(`${API_BASE_URL}/admin/newSubCategory`, {
      ...
      .then(function (response) {
        ...
        getSubcategory();
        Alert.alert("Thông báo", "Thêm danh mục con thành công");
        setSubcategoryName("");
      })
      .catch(function (error) {
        console.log(error);
  ...
  const deleteSubcategory = (id) => {
    axios
      .delete(`${API_BASE_URL}/admin/deleteSubCategory`, {
        data: {
          categoryId: categoryId,
          subCategoryId: id,
        },
      ...
      .then(function (response) {
        console.log(response.data);
        getSubcategory();
        Alert.alert("Thông báo", "Xóa danh mục con thành công");
      })
      .catch(function (error) {
        console.log(error);
      });
  ...
  const updateSubcategory = () => {
    axios
      .put(`${API_BASE_URL}/admin/updateSubCategory`, {
        categoryId: categoryId,
      ...
      .then(function (response) {
        console.log(response.data);
        getSubcategory();
        Alert.alert("Thông báo", "Cập nhật danh mục con thành công");
        closeModal();
      })
      .catch(function (error) {
        console.log(error);
                ...
                onPress={() => {
                  Alert.alert(
                    ...
                    [
                      ...
                      { text: "Xóa", onPress: () => deleteSubcategory(item._id) },
                    ]
                  );
                }}
              >
...
export default SubcategoryManagerScreen;
